...
class DocumentTest < ActiveSupport::TestCase
	...
	test "should return s3_string_to_sign" do
		...
		assert_equal object.document.url, "/system/documents/1/original/BogusFileName."
	...
	test "should return s3_url" do
		...
		assert_equal "https://s3.amazonaws.com/system/documents/1/original/BogusFileName.?" +
			"AWSAccessKeyId=test_access_key_id&" +
			"Signature=sZveTMHwpLQk0tA7amx2JNqN7NY%3D&Expires=1281066749",object.s3_url
	end
