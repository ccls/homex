...
Added options reader to Aegis::Role.  initialize accepts it, but the developer never has access to it.  I'd like to pass :position so that I can sort my roles based on something other than randomness.
