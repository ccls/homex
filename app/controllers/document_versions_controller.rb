...
#		flash.now[:error] = "There was a problem creating the document_version"
#		render :action => "new"
#	end
#
#	def update
...
#	rescue ActiveRecord::RecordNotSaved, ActiveRecord::RecordInvalid
#		flash.now[:error] = "There was a problem updating the document_version"
#		render :action => "edit"
#	end
#
#	def destroy
...
#		if !params[:id].blank? and DocumentVersion.exists?(params[:id])
