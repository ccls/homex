...
class Hx::EnrollsControllerTest < ActionController::TestCase
#
...
#		assert_match hx_enrolls_path, @response.redirected_to
...
#			:subjects => [ ]
#		assert_response :redirect
#		assert_match send_letters_hx_enrolls_path, @response.redirected_to
