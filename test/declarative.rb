...
#
#		NameError: undefined method `test_with_verbosity' for class `ActiveSupport::TestCase'
#
#	or
#
#	./test/unit/../declarative.rb:26:in `test_without_verbosity': wrong number of arguments (1 for 2) (ArgumentError)
#
