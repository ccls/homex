...
* The way that surveyor uses fixtures will make it challenging for adding new surveys as adding them destroys and you can't replace or remove an individual survey.
