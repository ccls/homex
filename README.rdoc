...
* {calnet_authentication}[http://github.com/jakewendt/calnet_authentication] - user authentication
...
* {stringify_date}[http://github.com/jakewendt/stringify_date]
...
* {ucb_ccls_engine}[http://github.com/jakewendt/ucb_ccls_engine] - contains all of the user authorization and other code used in several apps
