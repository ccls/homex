...
* {jakewendt-ccls_engine}[http://github.com/jakewendt/ucb_ccls_engine] - contains all of the common code used in several apps
* {jakewendt-calnet_authenticated}[http://github.com/jakewendt/calnet_authenticated] - user authentication
* {jakewendt-authorized}[http://github.com/jakewendt/authorized] - user authorization
