...
For rvm / jruby users, things get a bit more complicated, at least until I figure out how to simplify.
 ...
 gem install aegis RedCloth chronic packet rubycas-client ucb_ldap active_shipping ryanb-acts-as-list rcov mocha autotest-rails ZenTest thoughtbot-factory_girl activerecord-jdbcmysql-adapter jdbc-sqlite3
