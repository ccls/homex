...
* {Surveyor}[http://github.com/breakpointer/surveyor] - for the taking of surveys (using plugin instead of gem)
...
== Installation
 ...
 #	Need to manually install these first
 gem source -a http://gemcutter.org
 gem source -a http://gems.github.com
 sudo gem install rails -v 2.3.4
 sudo gem install aegis surveyor packet rdoc sqlite3
