...
=== Vaguely related fixes

* Make RDoc auto recognize associations and group them together under separate headings (like Public Instance Methods, Private Instance Methods, etc.)  These associations should auto link and would be a nice start to creating UML diagrams from the source code. (I know, UML is supposed to come first.)
  * has_many
  * has_one
  * belongs_to
...
* the plugin rdoc_rails on github doesn't work, but would be nice in theory
* rdoc the rake tasks??
