...
* {authlogic}[http://github.com/binarylogic/authlogic] - for user authentication
...
* {authlogic_extension}[http://github.com/jakewendt/authlogic_extension] - modifications, updates and patches for authlogic gem.
...
Everybody join hands together now to install some gems ...
 ...
 sudo gem install rake rdoc aegis packet haml
...
#
#	UID is gone so need to change this
#		(set role_name to 'administrator')
#
# rake app:deputize uid=<Your CalNet UID>				#	TODO
...
{AuthLogic Activation Tutorial}[http://www.claytonlz.com/index.php/2009/07/authlogic-account-activation-tutorial/]
