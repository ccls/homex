...
* {html_test}[http://github.com/peter/html_test] - testing
...
* stub out UCB::LDAP::Person.find_by_uid(uid) for testing
** first UCB::LDAP::Person call always warns "warning: peer certificate won't be verified in this SSL session"
** just not working
* stub out FedEx#find_tracking_info(tracking_number, :test => true) for testing
